...
| ![image-20201229113148367](media/image-20201229113148367.png) | ![image-20201229113341539](media/image-20201229113341539.png) |
 ...
 - **few shot segmentation**
   -  因为同category的shape的convex组合之间已经建立起了`correspondence`，只需要手动给几个shape标一下convex id对应的part label，就可以利用correspondence获得其他同category shape的标注<br><img src="media/image-20201229113640866.png" alt="image-20201229113640866"  />
 - **results**
    - <img src="media/image-20201229113556212.png" alt="image-20201229113556212" />
    - <img src="media/image-20201229114054936.png" alt="image-20201229114054936" />
...
- **overview**
  ...
  - 学SDF时的常规loss：<br>有数据处函数值为0，法向量为真值；<br>(无数据处)空间分布的点法向量2-norm为1<br><img src="media/image-20201228172709924.png" alt="image-20201228172709924" />
  - 然而只有上述loss存在问题
    - 首先，不能保证学到的是SDF
